              ...
              if (mutation.type === 'childList') {
                if (mutation.addedNodes.length > 0) {
                    for(i of mutation.addedNodes) {
                        if ((e.getAttribute('actionButton') == '' || !e.hasAttribute('actionButton') && (i.tagName != 'LI' || i.getElementsByClassName('actionButton').length == 1)) { } else { // allows users  to create custom action buttons elements other than a button
