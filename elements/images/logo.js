...
let pixelSize = 1.85; // og:6 size of the pixel squares that are drawn on the canvas
let size = 60; //og 224 // size of the canvas or image, this should be a square image
