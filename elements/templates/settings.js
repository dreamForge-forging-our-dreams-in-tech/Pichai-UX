    ...
    async connectedCallback() {
        ...
        this.firstChild.addEventListener('itemSelected', async function (e) {
            if (e.detail.value == 'wallpaper') {
                ...
                if (await window.parent.showConfirmDialog('Are you sure?', 'Are you sure you want to clear all data?')) {
                    ...
                    await window.parent.showAlertDialog('Data cleared', 'Please refresh your window to finalize reset.');
                }
